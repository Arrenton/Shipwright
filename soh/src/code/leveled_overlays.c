...
void Leveled_KaleidoEquip_Stats(PlayState* play) {
    ...
    Leveled_DrawTex32(play, (u8*)gItemIconSwordKokiriTex, 32, 32, -192, -268, 32, 32);
        Leveled_DrawTex32(play, (u8*)gItemIconSilverGauntletsTex, 32, 32, -192, -268, 32, 32);
    Leveled_DrawTex32(play, (u8*)gItemIconShieldHylianTex, 32, 32, -192, -268, 32, 32);
    Leveled_DrawTexIA8(play, (u8*)gHeartFullTex, 16, 16, -114, -222, 16, 16, 255, 255, 255);
    Leveled_DrawTex32(play, (u8*)gQuestIconMagicJarBigTex, 24, 24, -114, -222, 24, 24);
    Leveled_DrawTexI8(play, (u8*)digitTextures[1], 8, 16, -114, -222, 8, 16, 255, 255, 255);
    Leveled_DrawTex32(play, (u8*)gItemIconGoronsBraceletTex, 32, 32, -192, -268, 32, 32);
